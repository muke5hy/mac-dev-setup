...
We'll come back to the details of that later, but for now, just download the files [.bash_profile](https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.bash_profile), [.bash_prompt](https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.bash_prompt), [.aliases](https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.aliases) attached to this document into your home directory (`.bash_profile` is the one that gets loaded, I've set it up to call the others):

```
cd ~
curl -O https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.bash_profile
curl -O https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.bash_prompt
curl -O https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.aliases
```
...
Let's set up some basic configuration. Download the [.gitconfig](https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.gitconfig) file to your home directory:

```
cd ~
curl -O https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.gitconfig
```
...
```
cd ~
curl -O https://raw.githubusercontent.com/muke5hy/mac-dev-setup/master/.gitignore
...
- [lasstpass](https://lastpass.com/): Securely store your login and passwords, and access them from all your devices. **($3/month)**
...
- [Rectangle](https://github.com/rxhanson/Rectangle): Move and resize windows with keyboard shortcuts. **(Free)**
